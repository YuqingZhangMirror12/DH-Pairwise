...
2026-09-25 最新补充：[S7-Consensus 归并修复说明、代码入口与重训边界](S7_CONSENSUS_MERGE_REPAIR.md)。当前实现修复“同一相近摆放的支持组被过严拒绝归并”，将真实对应并集共同用于 Layout 和 Scorer。以下正文仍是 09-21 历史研究快照，不代表修复版训练已完成。
