"""Materialize paired N512/N1024 from one immutable fixed E1 TRAIN selection.
...
PIPELINE='paired-source-cell-density-materialization/1'
...
def pipeline_identity():
    from staging.pairwise_v0_2.pairwise_data import (
        ...
        rachel_edge_weathering,rachel_paired_density_dataset)
    modules=(rachel_source_density,rachel_source_density_records,rachel_preprocess,rachel_union_augmentation,
             rachel_edge_weathering,rachel_paired_density_dataset)
    return dict(version=PIPELINE,code_sha256={m.__name__:file_sha256(m.__file__) for m in modules},
