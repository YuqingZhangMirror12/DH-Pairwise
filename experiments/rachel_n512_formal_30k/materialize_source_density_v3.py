"""Version3: materialize paired source density with bounded unknown isolation.
...
from staging.pairwise_v0_2.pairwise_data.rachel_density_ownership_v3 import resample_source_density_v3 as resample_source_density
from staging.pairwise_v0_2.pairwise_data.rachel_density_ownership_v3 import SourceDensityRecordResolverV3 as SourceDensityRecordResolver
...
PIPELINE='paired-source-cell-density-materialization/3'
...
def pipeline_identity():
    from staging.pairwise_v0_2.pairwise_data import (
        ...
        rachel_edge_weathering,rachel_paired_density_dataset,rachel_density_ownership_v2,rachel_density_ownership_v3)
    modules=(rachel_source_density,rachel_source_density_records,rachel_preprocess,rachel_union_augmentation,
             rachel_edge_weathering,rachel_paired_density_dataset,rachel_density_ownership_v2,rachel_density_ownership_v3)
    return dict(version=PIPELINE,source_density_version='v3',ownership_protocol='density-local-unknown-ownership/3',code_sha256={m.__name__:file_sha256(m.__file__) for m in modules},
