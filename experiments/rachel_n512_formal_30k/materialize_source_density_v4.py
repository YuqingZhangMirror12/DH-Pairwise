"""Version4: materialize paired source density with bounded unknown isolation.
...
from staging.pairwise_v0_2.pairwise_data.rachel_density_ownership_v4 import resample_source_density_v4 as resample_source_density
from staging.pairwise_v0_2.pairwise_data.rachel_density_ownership_v4 import SourceDensityRecordResolverV4 as SourceDensityRecordResolver
...
PIPELINE='paired-source-cell-density-materialization/4'
...
def pipeline_identity():
    from staging.pairwise_v0_2.pairwise_data import (
        ...
        rachel_edge_weathering,rachel_paired_density_dataset,rachel_density_ownership_v2,rachel_density_ownership_v3,rachel_density_ownership_v4,rachel_density_outer_certificate)
    modules=(rachel_source_density,rachel_source_density_records,rachel_preprocess,rachel_union_augmentation,
             rachel_edge_weathering,rachel_paired_density_dataset,rachel_density_ownership_v2,rachel_density_ownership_v3,rachel_density_ownership_v4,rachel_density_outer_certificate)
    return dict(version=PIPELINE,source_density_version='v4',ownership_protocol='density-local-unknown-ownership/4',code_sha256={m.__name__:file_sha256(m.__file__) for m in modules},
